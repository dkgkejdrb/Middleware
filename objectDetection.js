...
const upload = multer({ dest: "uploads/objectDetection/" }).single("image");
...
app.post("/objectDetection", (req, res) => {
    upload(req, res, (err) => {
      ...
      if (file != null) {
        ...
        form.append("image", fs.createReadStream("uploads/objectDetection/" + file.filename));
