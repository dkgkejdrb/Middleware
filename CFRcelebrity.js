// searchCelebrity  /celebrity  post  유명인 얼굴 인식 결과 반환
...
const upload = multer({ dest: "uploads/CFRcelebrity/" }).single("image");
  ...
  upload(req, res, (err) => {
    if (err instanceof multer.MulterError) {
      ...
      if (file !== null) {
        ...
        form.append("image", fs.createReadStream("uploads/CFRcelebrity/" + file.filename));
        axios
          .post(api_url, form, {
            headers: {
